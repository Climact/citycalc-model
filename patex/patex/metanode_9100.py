...
def metanode_9100(port_01, port_02, port_03, port_04):
    ...
    network_losses_TWh = ImportDataNode(trigram='elc', variable_name='network-losses', variable_type='HTS')()
    # HTS network-losses-additional [TWh]
    network_losses_additional_TWh = ImportDataNode(trigram='elc', variable_name='network-losses-additional', variable_type='HTS')()

    # Add demand for refineries to energy demand

    # OTS (only) energy-demand [TWh] (electricity demand for refineries)
    energy_demand_TWh = ImportDataNode(trigram='elc', variable_name='energy-demand', variable_type='OTS (only)')()
    # Same as last available year
    energy_demand_TWh = AddMissingYearsNode()(df_data=energy_demand_TWh)
    # energy-demand[TWh] = network-losses[TWh] + network-losses-additional[TWh]
    energy_demand_TWh_2 = MCDNode(operation_selection='x + y', output_name='energy-demand[TWh]')(input_table_1=network_losses_TWh, input_table_2=network_losses_additional_TWh)
    # sector = losses
    ...
    # Industry
    out_7478_1 = InjectVariablesDataNode()(df=port_03)

    # CO2 production (Carbon Capture)

    # CC [Mt]
    CC_Mt = UseVariableNode(selected_variable='CC[Mt]')(input_table=out_7478_1)
    # sector = ind
    CC_Mt['sector'] = "ind"
    ...
    # energy-demand [TWh]
    energy_demand_TWh_2 = UseVariableNode(selected_variable='energy-demand[TWh]')(input_table=out_7478_1)
    # sector = ind
    ...
    # CCU [Mt]
    CCU_Mt = UseVariableNode(selected_variable='CCU[Mt]')(input_table=out_7478_1)
    # sector = ind
    CCU_Mt['sector'] = "ind"
    # CCU [Mt]
    CCU_Mt = ExportVariableNode(selected_variable='CCU[Mt]')(input_table=CCU_Mt)
    # Buildings
    out_7477_1 = InjectVariablesDataNode()(df=port_02)
    # sector = bld
    ...
    # energy-demand [TWh]
    energy_demand_TWh = ExportVariableNode(selected_variable='energy-demand[TWh]')(input_table=out_6998_1)
    ...
    primary_energy_demand_TWh = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=out_6428_8)
    ...
    primary_energy_demand_TWh = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=primary_energy_demand_TWh)
    # CC [Mt]
    CC_Mt_2 = UseVariableNode(selected_variable='CC[Mt]')(input_table=out_6428_7)
    # CC [Mt]
    CC_Mt_2 = UseVariableNode(selected_variable='CC[Mt]')(input_table=CC_Mt_2)
    # CC [Mt]
    CC_Mt_2 = UseVariableNode(selected_variable='CC[Mt]')(input_table=CC_Mt_2)
    # CC [Mt]
    CC_Mt_3 = UseVariableNode(selected_variable='CC[Mt]')(input_table=CC_Mt_2)
    # capex-opex [MEUR]
    out_6428_3 = ColumnFilterNode(pattern='^.*$')(df=out_6428_3)
    ...
    # primary-energy-demand [TWh]
    primary_energy_demand_TWh_2 = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=out_6428_4)
    # Group by  country, years, primary-energy-carrier, sector, way-of-production
    primary_energy_demand_TWh_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production', 'primary-energy-carrier', 'sector'], aggregation_method='Sum')(df=primary_energy_demand_TWh_2)
    ...
    # energy-imported [TWh]
    energy_imported_TWh = ExportVariableNode(selected_variable='energy-imported[TWh]')(input_table=out_6428_1)
    ...
    out_6428_6 = ColumnFilterNode(columns_to_drop=[])(df=out_6428_6)
    # energy-production [TWh]
    energy_production_TWh = ExportVariableNode(selected_variable='energy-production[TWh]')(input_table=out_6428_2)
    ...
    # energy-production [TWh]
    energy_production_TWh_2 = UseVariableNode(selected_variable='energy-production[TWh]')(input_table=energy_production_TWh)
    ...
    # emissions [Mt]
    emissions_Mt = UseVariableNode(selected_variable='emissions[Mt]')(input_table=out_6428_5)
    ...
    emissions_Mt = UseVariableNode(selected_variable='emissions[Mt]')(input_table=emissions_Mt)
    # energy-demand [TWh]
    energy_demand_TWh = UseVariableNode(selected_variable='energy-demand[TWh]')(input_table=out_7248_1)
    ...
    # Energy demand [TWh]
    energy_demand_TWh = UseVariableNode(selected_variable='energy-demand[TWh]')(input_table=out_5960_1)
    ...
    # capex-opex [MEUR]
    out_6429_3 = ColumnFilterNode(pattern='^.*$')(df=out_6429_3)
    # capex-opex [MEUR]
    out_6429_3 = ColumnFilterNode(pattern='^.*$')(df=out_6429_3)
    # Node 5876
    out_3 = pd.concat([out_6428_3, out_6429_3.set_index(out_6429_3.index.astype(str) + '_dup')])
    # Set to 0
    out_3 = MissingValueNode(DTS_DT_O=[['org.knime.core.data.def.IntCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.StringCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.DoubleCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.FixedDoubleValueMissingCellHandlerFactory']], FixedValue='0.0')(df=out_3)
    ...
    # capex-opex [MEUR]
    out_3 = ColumnFilterNode(pattern='^Country$|^Years$|^sector$|^.*$')(df=out_3)

    # Carbon Capture Use (CCU) and Direct air Capture (DAC)

    # CCU [Mt]
    CCU_Mt = UseVariableNode(selected_variable='CCU[Mt]')(input_table=out_6429_5)
    # CCU [Mt]
    CCU_Mt = UseVariableNode(selected_variable='CCU[Mt]')(input_table=CCU_Mt)
    # emissions [Mt]
    out_9635_1 = CCU_Mt.rename(columns={'CCU[Mt]': 'emissions[Mt]'})
    # Add emissions-or-capture (=CCU)
    out_9635_1['emissions-or-capture'] = "CCU"
    # primary-energy-demand [TWh]
    primary_energy_demand_TWh_2 = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=out_6429_4)
    # Group by  country, years,  primary-energy-carrier, sector, way-of-production
    primary_energy_demand_TWh_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production', 'primary-energy-carrier', 'sector'], aggregation_method='Sum')(df=primary_energy_demand_TWh_2)
    # primary-energy-demand to energy-demand  and  primary-energy-carrier to energy-carrier
    ...
    # capex-opex [MEUR]
    out_6430_3 = ColumnFilterNode(pattern='^.*$')(df=out_6430_3)
    # capex-opex [MEUR]
    out_6430_3 = ColumnFilterNode(pattern='^.*$')(df=out_6430_3)
    # Node 5876
    ...
    # primary-energy-demand [TWh]
    primary_energy_demand_TWh_2 = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=out_6430_4)
    ...
    # energy-imported [TWh]
    energy_imported_TWh = ExportVariableNode(selected_variable='energy-imported[TWh]')(input_table=out_6430_1)
    ...
    # energy-production [TWh]
    energy_production_TWh = ExportVariableNode(selected_variable='energy-production[TWh]')(input_table=out_6430_2)
    ...
    # Energy demand [TWh]
    energy_demand_TWh = UseVariableNode(selected_variable='energy-demand[TWh]')(input_table=out_5982_1)
    ...
    # energy-demand [TWh]
    energy_demand_TWh = ExportVariableNode(selected_variable='energy-demand[TWh]')(input_table=out_7083_2)
    ...
    cal_rate_energy_demand_TWh = ExportVariableNode(selected_variable='cal_rate_energy-demand[TWh]')(input_table=out_7083_1)
    ...
    # Calibration (energy-demand)
    cal_rate_energy_demand_TWh = UseVariableNode(selected_variable='cal_rate_energy-demand[TWh]')(input_table=cal_rate_energy_demand_TWh)
    # energy-imported [TWh]
    energy_imported_TWh_3 = ExportVariableNode(selected_variable='energy-imported[TWh]')(input_table=out_6429_1)
    # energy-imported [TWh]
    energy_imported_TWh_3 = UseVariableNode(selected_variable='energy-imported[TWh]')(input_table=energy_imported_TWh_3)
    # Node 5876
    ...
    # energy-imported [TWh]
    energy_imported_TWh_2 = UseVariableNode(selected_variable='energy-imported[TWh]')(input_table=energy_imported_TWh_2)
    # Node 5876
    ...
    direct_air_capture_Mt = UseVariableNode(selected_variable='direct-air-capture[Mt]')(input_table=out_6429_6)
    # direct-air-capture [Mt]
    direct_air_capture_Mt = UseVariableNode(selected_variable='direct-air-capture[Mt]')(input_table=direct_air_capture_Mt)
    # emissions [Mt]
    ...
    # energy-production [TWh]
    energy_production_TWh_3 = ExportVariableNode(selected_variable='energy-production[TWh]')(input_table=out_6429_2)
    # energy-production [TWh]
    energy_production_TWh_3 = UseVariableNode(selected_variable='energy-production[TWh]')(input_table=energy_production_TWh_3)
    # Node 5876
    ...
    # energy-production [TWh]
    energy_production_TWh_2 = UseVariableNode(selected_variable='energy-production[TWh]')(input_table=energy_production_TWh_2)
    # Node 5876
    ...
    # emissions [Mt]
    emissions_Mt_2 = UseVariableNode(selected_variable='emissions[Mt]')(input_table=out_9763_7)
    # Node 5876
    ...
    # backup-capacity [GW]
    backup_capacity_GW = UseVariableNode(selected_variable='backup-capacity[GW]')(input_table=out_9763_12)
    # CC [Mt]
    CC_Mt_2 = UseVariableNode(selected_variable='CC[Mt]')(input_table=out_9763_8)
    ...
    CC_Mt_3 = UseVariableNode(selected_variable='CC[Mt]')(input_table=CC_Mt_2)
    # primary-energy-demand [TWh]
    primary_energy_demand_TWh_2 = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=out_9763_13)
    ...
    primary_energy_demand_TWh = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=primary_energy_demand_TWh)
    # primary-energy-demand [TWh]
    primary_energy_demand_TWh_2 = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=out_9763_6)
    # Group by  country, years, primary-energy-carrier, sector, way-of-prod
    primary_energy_demand_TWh_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production', 'primary-energy-carrier', 'sector'], aggregation_method='Sum')(df=primary_energy_demand_TWh_2)
    # primary-energy-demand to energy-demand  and  primary-energy-carrier to energy-carrier
    ...
    # energy-demand [TWh]
    energy_demand_TWh = ExportVariableNode(selected_variable='energy-demand[TWh]')(input_table=out_7084_2)
    ...
    # capex-opex [MEUR]
    out_6432_5 = ColumnFilterNode(pattern='^Country$|^Years$|^sector$|^.*capex.*$|^.*opex.*$|^cost-user$')(df=out_6432_5)
    ...
    # capex-opex [MEUR]
    out_6432_5 = ColumnFilterNode(pattern='^.*$')(df=out_6432_5)
    ...
    # primary-energy-demand [TWh]
    primary_energy_demand_TWh_2 = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=out_6432_6)
    # Group by  country, years, primary-energy-carrier, sector, way-of-prod
    primary_energy_demand_TWh_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production', 'primary-energy-carrier', 'energy-carrier-category', 'sector'], aggregation_method='Sum')(df=primary_energy_demand_TWh_2)
    # primary-energy-demand to energy-demand  and  primary-energy-carrier to energy-carrier
    ...
    out_6432_1 = ColumnFilterNode(columns_to_drop=[])(df=out_6432_1)
    ...
    out_6432_1 = ColumnFilterNode(columns_to_drop=[])(df=out_6432_1)
    # primary-energy-demand [TWh]
    primary_energy_demand_TWh_2 = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=out_6432_9)
    primary_energy_demand_TWh = pd.concat([primary_energy_demand_TWh_2, primary_energy_demand_TWh.set_index(primary_energy_demand_TWh.index.astype(str) + '_dup')])
    # primary-energy-demand [TWh]  only for CC
    primary_energy_demand_TWh = UseVariableNode(selected_variable='primary-energy-demand[TWh]')(input_table=primary_energy_demand_TWh)
    # Group by  way-of-production (sum)
    primary_energy_demand_TWh = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production'], aggregation_method='Sum')(df=primary_energy_demand_TWh)
    ...
    # CC [Mt]
    CC_Mt_2 = UseVariableNode(selected_variable='CC[Mt]')(input_table=out_6432_8)
    # Node 5876
    CC_Mt_2 = pd.concat([CC_Mt_2, CC_Mt_3.set_index(CC_Mt_3.index.astype(str) + '_dup')])
    # CC [Mt] from Power
    CC_Mt_2 = UseVariableNode(selected_variable='CC[Mt]')(input_table=CC_Mt_2)
    ...
    # emissions [Mt]
    emissions_Mt_2 = UseVariableNode(selected_variable='emissions[Mt]')(input_table=out_6432_7)
    # Node 5876
    emissions_Mt = pd.concat([emissions_Mt_2, emissions_Mt.set_index(emissions_Mt.index.astype(str) + '_dup')])
    ...
    emissions_Mt_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'gaes'], aggregation_method='Sum')(df=emissions_Mt_2)
    # OTS (only) power-gaes-additional [Gt]
    power_gaes_additional_Gt = ImportDataNode(trigram='elc', variable_name='power-gaes-additional', variable_type='OTS (only)')()
    # Convert Gt to Mt
    ...
    ratio_emissions_percent = MCDNode(operation_selection='y / x', output_name='ratio-emissions[%]')(input_table_1=emissions_Mt_2, input_table_2=power_gaes_additional_Mt)
    # Set to 0
    ratio_emissions_percent = MissingValueNode(DTS_DT_O=[['org.knime.core.data.def.IntCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.StringCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.DoubleCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.FixedDoubleValueMissingCellHandlerFactory']], FixedValue='0.0')(df=ratio_emissions_percent)
    # Same as last available year
    ratio_emissions_percent = AddMissingYearsNode()(df_data=ratio_emissions_percent)
    # emissions[Mt] (replace) = ratio-emissions[%] * emissions[Mt]
    emissions_Mt_2 = MCDNode(operation_selection='x * y', output_name='emissions[Mt]')(input_table_1=emissions_Mt_2, input_table_2=ratio_emissions_percent)
    ...
    emissions_Mt = MCDNode(operation_selection='x * y', output_name='emissions[Mt]', fill_value_bool='Left [x] Outer Join', fill_value=1.0)(input_table_1=out_1, input_table_2=power_ets_share_)
    ...
    # emissions [Mt]
    emissions_Mt = UseVariableNode(selected_variable='emissions[Mt]')(input_table=out_9210_1)
    ...
    # emissions[Mt] (replace) = emissions[Mt] * power-ets-share[-]  LEFT Join If missing ; set to 1
    emissions_Mt_2 = MCDNode(operation_selection='x * y', output_name='emissions[Mt]', fill_value_bool='Left [x] Outer Join', fill_value=1.0)(input_table_1=emissions_Mt_2, input_table_2=power_ets_share_)
    ...
    # emissions [Mt]
    emissions_Mt_2 = UseVariableNode(selected_variable='emissions[Mt]')(input_table=out_9209_1)

    # For : Climate
    # - Emissions

    # emissions [Mt]
    emissions_Mt_3 = UseVariableNode(selected_variable='emissions[Mt]')(input_table=emissions_Mt_2)
    ...
    emissions_Mt_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'gaes', 'sector'], aggregation_method='Sum')(df=emissions_Mt_2)
    # emissions[MtCO2eq] = emissions[Mt] *  gwp[-]
    emissions_MtCO2eq = MCDNode(operation_selection='x * y', output_name='emissions[MtCO2eq]')(input_table_1=emissions_Mt_2, input_table_2=gwp_100)
    # Group by country, years, sector (sum)
    emissions_MtCO2eq = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=emissions_MtCO2eq)
    # energy-imported [TWh]
    energy_imported_TWh = ExportVariableNode(selected_variable='energy-imported[TWh]')(input_table=out_6432_3)
    ...
    net_energy_production_TWh = UseVariableNode(selected_variable='net-energy-production[TWh]')(input_table=out_6432_4)
    # Group by  country, years, way-of-prod
    net_energy_production_TWh = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production'], aggregation_method='Sum')(df=net_energy_production_TWh)
    ...
    # energy-production [TWh]
    energy_production_TWh = ExportVariableNode(selected_variable='energy-production[TWh]')(input_table=out_6432_2)
    ...
    energy_demand_TWh = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production', 'energy-carrier', 'sector'], aggregation_method='Sum')(df=energy_demand_TWh)
    ...
    # energy-demand [TWh]
    energy_demand_TWh = UseVariableNode(selected_variable='energy-demand[TWh]')(input_table=out_6439_1)
    ...
    ff_demand_per_cap_TWh_per_cap = MCDNode(operation_selection='x / y', output_name='ff-demand-per-cap[TWh/cap]')(input_table_1=energy_demand_TWh_2, input_table_2=population_cap)
    ...
    ff_demand_per_cap_MWh_per_cap = ExportVariableNode(selected_variable='ff-demand-per-cap[MWh/cap]')(input_table=ff_demand_per_cap_MWh_per_cap)
    ...
    energy_demand_TWh_5 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=energy_demand_TWh_3)
    # Keep electricity
    ...
    energy_demand_TWh_4 = GroupByDimensions(groupby_dimensions=['Country', 'Years'], aggregation_method='Sum')(df=energy_demand_TWh_4)
    # Keep fossil fuels
    ...
    # Group by Country, Years (sum)
    energy_demand_TWh_6 = GroupByDimensions(groupby_dimensions=['Country', 'Years'], aggregation_method='Sum')(df=energy_demand_TWh_6)
    # Keep biomass
    ...
    # Group by Country, Years (sum)
    energy_demand_TWh_7 = GroupByDimensions(groupby_dimensions=['Country', 'Years'], aggregation_method='Sum')(df=energy_demand_TWh_7)
    # Keep H2 + e-fuels
    ...
    # Group by Country, Years (sum)
    energy_demand_TWh_5 = GroupByDimensions(groupby_dimensions=['Country', 'Years'], aggregation_method='Sum')(df=energy_demand_TWh_5)
    # Group by Country, Years (sum)
    ...
    total_fec_alternative_fuels_share_percent = MCDNode(operation_selection='x / y', output_name='total-fec-alternative-fuels-share[%]')(input_table_1=energy_demand_TWh_5, input_table_2=energy_demand_TWh_3)
    # biomass-share [%]
    total_fec_biomass_share_percent = MCDNode(operation_selection='x / y', output_name='total-fec-biomass-share[%]')(input_table_1=energy_demand_TWh_7, input_table_2=energy_demand_TWh_3)
    ...
    # ff-share [%]
    total_fec_ff_share_percent = MCDNode(operation_selection='x / y', output_name='total-fec-ff-share[%]')(input_table_1=energy_demand_TWh_6, input_table_2=energy_demand_TWh_3)
    # electricity-share [%]
    total_fec_electricity_share_percent = MCDNode(operation_selection='x / y', output_name='total-fec-electricity-share[%]')(input_table_1=energy_demand_TWh_4, input_table_2=energy_demand_TWh_3)
    ...
    energy_demand_TWh_4 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'sector'], aggregation_method='Sum')(df=energy_demand_TWh_3)
    ...
    out_6544_1, _, _ = PivotingNode(agg_dict={'energy-demand[TWh]': 'sum'}, column_name_option='Pivot name+Aggregation name', column_name_policy='Keep original name(s)', list_group_columns=['Country', 'Years'], list_pivots=['energy-carrier'])(df=energy_demand_TWh_5)
    out_6545_1 = MissingValueColumnFilterNode(missing_threshold=0.9, type_of_pattern='Manual')(df=out_6544_1)
    # Same as in Pathway Explorer
    out_6545_1 = ColumnRenameRegexNode(search_string='(.*)\\+(.*)\\[.*', replace_string='$2_$1[TWh]')(df=out_6545_1)
    out_7056_1 = TreeMergeGroupsNode(new_column_name='energy-demand-total', aggregation_method='Sum', unit='TWh', aggregation_pattern='energy-demand_(.*-ff).*\\[.*')(df=out_6545_1)
    ...
    out_7062_1 = JoinerNode(joiner='inner', left_input=['Country', 'Years'], right_input=['Country', 'Years'])(df_left=out_6549_1, df_right=elc_electricity_demand_total_GWh)
    ...
    # Module = Bioenergy
    energy_demand_TWh_4 = ColumnFilterNode(pattern='^.*$')(df=energy_demand_TWh_4)
    # energy-demand [TWh]
    ...
    out_6651_1 = JoinerNode(joiner='inner', left_input=['sector'], right_input=['sector'])(df_left=energy_demand_TWh_5, df_right=out_6652_1)
    ...
    energy_demand_TWh_6 = MCDNode(operation_selection='x * y', output_name='energy-demand[TWh]', fill_value_bool='Left [x] Outer Join', fill_value=1.0)(input_table_1=out_6651_1, input_table_2=power_ets_share_)
    ...
    out_9495_1_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=out_9495_1_2)
    ...
    out_9495_1_3 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=out_9495_1_2)
    ...
    out_9495_1_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector', 'direct-use'], aggregation_method='Sum')(df=out_9495_1_2)
    ...
    out_9495_1_3 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'ets-or-not'], aggregation_method='Sum')(df=out_9495_1_2)
    ...
    out_9495_1_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'ets-or-not'], aggregation_method='Sum')(df=out_9495_1_2)
    ...
    out_9495_1 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=out_9495_1_2)
    ...
    out_9495_1_excluded_excluded = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'direct-use'], aggregation_method='Sum')(df=out_9495_1_excluded_excluded)
    ...
    out_9495_1_excluded_excluded_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=out_9495_1_excluded_excluded)
    # pct-direct-use[%] = energy-demand[TWh] / SUM(energy-demand[TWh])
    pct_direct_use_percent = MCDNode(operation_selection='y / x', output_name='pct-direct-use[%]')(input_table_1=out_9495_1_excluded_excluded_2, input_table_2=out_9495_1_excluded_excluded)
    ...
    out_9495_1_excluded = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'sector'], aggregation_method='Sum')(df=out_9495_1_excluded_2)
    # energy-demand[TWh] = energy-demand[TWh] * pct-direct-use[%]  LEFT JOIN If missing => set 1
    energy_demand_TWh_6 = MCDNode(operation_selection='x * y', output_name='energy-demand[TWh]', fill_value_bool='Left [x] Outer Join', fill_value=1.0)(input_table_1=out_9495_1_excluded, input_table_2=out_9454_1)
    ...
    energy_demand_TWh_6 = ColumnFilterNode(columns_to_drop=['direct-use'])(df=energy_demand_TWh_6)
    ...
    # Group by  country, years, sector
    out_9495_1 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=out_9495_1)
    ...
    energy_demand_TWh_7 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'sector'], aggregation_method='Sum')(df=energy_demand_TWh_6)
    ...
    # Group by  energy-carrier
    energy_demand_TWh_7 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=energy_demand_TWh_7)
    # electrification[%] = energy-demand[TWh] (elec only) / energy-demand[TWh] (total)
    electrification_percent = MCDNode(operation_selection='x / y', output_name='electrification[%]')(input_table_1=energy_demand_TWh_excluded, input_table_2=energy_demand_TWh_7)
    # Group by  way-of-prod
    energy_demand_TWh_6 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=energy_demand_TWh_6)
    # Group by  energy-carrier
    energy_demand_TWh_7 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=energy_demand_TWh_6)
    # Bottom:  electrycity (energy carrier)
    energy_demand_TWh_excluded = energy_demand_TWh_6.loc[energy_demand_TWh_6['energy-carrier'].isin(['electricity'])].copy()
    # Group by  energy-carrier
    energy_demand_TWh_excluded = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=energy_demand_TWh_excluded)
    # electrification[%] = energy-demand[TWh] (elec only) / energy-demand[TWh] (total)
    electrification_percent_2 = MCDNode(operation_selection='x / y', output_name='electrification[%]')(input_table_1=energy_demand_TWh_excluded, input_table_2=energy_demand_TWh_7)
    # KPI
    ...
    # electrification [%]
    electrification_percent = ExportVariableNode(selected_variable='electrification[%]')(input_table=electrification_percent)
    ...
    primary_costs_MEUR = MCDNode(operation_selection='x * y', output_name='primary-costs[MEUR]', fill_value_bool='Left [x] Outer Join')(input_table_1=energy_demand_TWh, input_table_2=primary_energy_costs_EUR_per_MWh)
    ...
    final_energy_costs_MEUR_3 = UseVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=out_7306_1)

    # Fuel Costs (Electricity)

    # primary-costs [MEUR]
    primary_costs_MEUR = UseVariableNode(selected_variable='primary-costs[MEUR]')(input_table=primary_costs_MEUR)
    # Keep only sector electricity
    primary_costs_MEUR_2 = primary_costs_MEUR.loc[primary_costs_MEUR['sector'].isin(['electricity'])].copy()
    # Group by  country, years, way-of-prod
    primary_costs_MEUR_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production'], aggregation_method='Sum')(df=primary_costs_MEUR_2)

    # Add Final Energy Costs to Primary-Costs

    # Group by  country, years, sector
    primary_costs_MEUR = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=primary_costs_MEUR)
    ...
    # fuel-price [MEUR/TWh]
    fuel_price_MEUR_per_TWh = UseVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=fuel_price_MEUR_per_TWh)
    # Keep only energy-carrier electricity
    ...
    # energy-demand [TWh]
    energy_demand_TWh_5 = UseVariableNode(selected_variable='energy-demand[TWh]')(input_table=energy_demand_TWh_5)
    ...
    # cal-rate [%]
    cal_rate_energy_demand_TWh_2 = ExportVariableNode(selected_variable='cal_rate_energy-demand[TWh]')(input_table=out_7084_1)
    # cal-rate [%]
    cal_rate_energy_demand_TWh_2 = UseVariableNode(selected_variable='cal_rate_energy-demand[TWh]')(input_table=cal_rate_energy_demand_TWh_2)
    ...
    # energy-demand [TWh]
    energy_demand_TWh_5 = UseVariableNode(selected_variable='energy-demand[TWh]')(input_table=out_6222_1)
    # Group by  country, years, energy-carrier, sector
    energy_demand_TWh_9 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'sector'], aggregation_method='Sum')(df=energy_demand_TWh_5)
    # Group by  country, years, energy-carrier
    energy_demand_TWh_5 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=energy_demand_TWh_5)
    # sector-share[%] = energy-demand[TWh] by sector / energy-demand[TWh] total
    sector_share_percent = MCDNode(operation_selection='x / y', output_name='sector-share[%]')(input_table_1=energy_demand_TWh_9, input_table_2=energy_demand_TWh_5)
    # Set to 0
    sector_share_percent = MissingValueNode(DTS_DT_O=[['org.knime.core.data.def.IntCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.StringCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.DoubleCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.FixedDoubleValueMissingCellHandlerFactory']], FixedValue='0.0')(df=sector_share_percent)
    ...
    sector_share_percent = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'sector'], aggregation_method='Sum')(df=sector_share_percent)

    # For : Pathway Explorer
    # - Capacity-factor

    # capacity-factor [%]
    capacity_factor_percent = UseVariableNode(selected_variable='capacity-factor[%]')(input_table=out_9763_11)
    # net-energy-production [TWh] FROM electricity  (does not account for eletricity production with CHP)
    net_energy_production_TWh = UseVariableNode(selected_variable='net-energy-production[TWh]')(input_table=out_9763_2)
    # Group by  country, years, way-of-prod, energy-carrier, primary-energy-carrier
    net_energy_production_TWh = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'way-of-production', 'primary-energy-carrier'], aggregation_method='Sum')(df=net_energy_production_TWh)
    ...
    # energy-imported[TWh]
    energy_imported_TWh_3 = ExportVariableNode(selected_variable='energy-imported[TWh]')(input_table=out_9763_3)
    # energy-imported [TWh]
    energy_imported_TWh_3 = UseVariableNode(selected_variable='energy-imported[TWh]')(input_table=energy_imported_TWh_3)
    # Node 5876
    energy_imported_TWh_2 = pd.concat([energy_imported_TWh_2, energy_imported_TWh_3.set_index(energy_imported_TWh_3.index.astype(str) + '_dup')])
    ...
    energy_imported_TWh = MissingValueNode(dimension_rx='^.*\\[.*•\\]$', DTS_DT_O=[['org.knime.core.data.def.IntCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.StringCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.FixedStringValueMissingCellHandlerFactory'], ['org.knime.core.data.def.DoubleCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory']], FixedValue='')(df=energy_imported_TWh)
    # energy-imported [TWh]
    energy_imported_TWh = UseVariableNode(selected_variable='energy-imported[TWh]')(input_table=energy_imported_TWh)
    ...
    # Remove imported var
    energy_exported_TWh = ColumnFilterNode(pattern='^((?!energy-imported\[TWh\]).)*$')(df=energy_exported_TWh)
    # Group by  country, years, sector, energy-carrier-category
    energy_exported_TWh_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector', 'energy-carrier-category'], aggregation_method='Sum')(df=energy_exported_TWh)
    ...
    # Group by  country, years, energy-carrier
    energy_exported_TWh = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=energy_exported_TWh)
    # add aggregation columns
    out_9586_1 = JoinerNode(joiner='inner', left_input=['energy-carrier'], right_input=['energy-carrier'])(df_left=energy_exported_TWh, df_right=out_9358_1)
    # Remove energy-carrier
    out_9586_1 = ColumnFilterNode(columns_to_drop=['energy-carrier'])(df=out_9586_1)
    # energy-carrier-agg to energy-carrier
    out_9353_1 = out_9586_1.rename(columns={'energy-carrier-agg': 'energy-carrier'})
    # Group by  country, years, energy-carrier
    out_9353_1 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=out_9353_1)
    ...
    energy_imported_TWh_3 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'energy-carrier-category'], aggregation_method='Sum')(df=energy_imported_TWh)
    ...
    energy_imported_TWh_excluded_2 = StringManipulationNode(expression='join($energy-carrier-category$, "-ff")', var_name='energy-carrier')(df=energy_imported_TWh_excluded_2)
    energy_imported_TWh_2 = StringManipulationNode(expression='join("liquid-syn")', var_name='energy-carrier')(df=energy_imported_TWh_3)
    ...
    # Sum on all dimensions to avoid duplicates
    energy_imported_TWh_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'energy-carrier-category'], aggregation_method='Sum')(df=energy_imported_TWh_2)
    # Remove energy-carrier-category
    energy_imported_TWh_2 = ColumnFilterNode(columns_to_drop=['energy-carrier-category'])(df=energy_imported_TWh_2)
    # energy-imported[TWh] = energy-import[TWh] * sector-share[%]
    energy_imported_TWh_2 = MCDNode(operation_selection='x * y', output_name='energy-imported[TWh]', fill_value_bool='Left [x] Outer Join', fill_value=1.0)(input_table_1=energy_imported_TWh_2, input_table_2=sector_share_percent)
    # Module = Scope 2 and 3
    energy_imported_TWh_2 = ColumnFilterNode(pattern='^.*$')(df=energy_imported_TWh_2)
    # Group by  country, years, energy-carrier
    energy_imported_TWh_3 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=energy_imported_TWh)
    # add aggregation columns
    out_9585_1 = JoinerNode(joiner='inner', left_input=['energy-carrier'], right_input=['energy-carrier'])(df_left=energy_imported_TWh_3, df_right=out_9358_1)
    # Remove energy-carrier
    out_9585_1 = ColumnFilterNode(columns_to_drop=['energy-carrier'])(df=out_9585_1)
    # energy-carrier-agg to energy-carrier
    out_9346_1 = out_9585_1.rename(columns={'energy-carrier-agg': 'energy-carrier'})
    # Group by  country, years, energy-carrier
    out_9346_1 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=out_9346_1)
    ...
    # Group by  country, years, sector, energy-carrier-category
    energy_imported_TWh = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector', 'energy-carrier-category'], aggregation_method='Sum')(df=energy_imported_TWh)
    # Keep refineries  sector
    ...
    # total-capacities [GW]
    total_capacities_GW = UseVariableNode(selected_variable='total-capacities[GW]')(input_table=out_9763_9)
    ...
    total_capacities_MW = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production'], aggregation_method='Sum')(df=total_capacities_MW)
    ...
    # Group by  country, years
    total_capacities_GW = GroupByDimensions(groupby_dimensions=['Country', 'Years'], aggregation_method='Sum')(df=total_capacities_GW)
    ...
    RES_cap_total_per_cap_W_per_cap = MCDNode(operation_selection='x / y', output_name='RES-cap-total-per-cap[W/cap]')(input_table_1=total_capacities_W, input_table_2=population_cap)
    # RES-cap-total-per-cap[W/cap]
    RES_cap_total_per_cap_W_per_cap = ExportVariableNode(selected_variable='RES-cap-total-per-cap[W/cap]')(input_table=RES_cap_total_per_cap_W_per_cap)
    # KPI
    ...
    cum_new_capacities_GW = UseVariableNode(selected_variable='cum-new-capacities[GW]')(input_table=out_9763_10)
    # Unit conversion GW to MW
    ...
    out_7610_1, _ = LagVariable(in_var='cum-new-capacities[GW]')(df=cum_new_capacities_GW)
    # cum-new-capacities -lagged [GW]
    cum_new_capacities_lagged_GW = UseVariableNode(selected_variable='cum-new-capacities_lagged[GW]')(input_table=out_7610_1)
    # new-capacities[GW] = cum-new-capacities [GW] - cum-new-capacities-lagged [GW]
    new_capacities_GW = MCDNode(operation_selection='x - y', output_name='new-capacities[GW]')(input_table_1=cum_new_capacities_GW, input_table_2=cum_new_capacities_lagged_GW)

    # Pivot

    out_7260_1, _, _ = PivotingNode(agg_dict={'new-capacities[GW]': 'sum'}, column_name_option='Pivot name+Aggregation name', column_name_policy='Keep original name(s)', list_group_columns=['Country', 'Years'], list_pivots=['way-of-production'])(df=new_capacities_GW)
    out_7261_1 = MissingValueColumnFilterNode(missing_threshold=0.9, type_of_pattern='Manual')(df=out_7260_1)
    # Same as in Pathway Explorer
    out_7261_1 = ColumnRenameRegexNode(search_string='(.*)\\+(.*)\\[.*', replace_string='$2_$1[GW]')(df=out_7261_1)
    ...
    # Remove solar-pv
    out_6983_1 = ColumnFilterNode(columns_to_drop=['new-capacities_RES-solar-pv[GW]'])(df=out_6983_1)
    out_7054_1 = JoinerNode(joiner='inner', left_input=['Country', 'Years'], right_input=['Country', 'Years'])(df_left=out_7062_1, df_right=out_6983_1)
    # Module = Minerals
    out_7054_1 = ColumnFilterNode(pattern='^.*$')(df=out_7054_1)
    # existing-capacities [GW]
    existing_capacities_GW = UseVariableNode(selected_variable='existing-capacities[GW]')(input_table=out_9763_14)
    # Unit conversion GW to MW
    ...
    # Calibration (primary energy demand & emissions)
    out_9763_1 = ColumnFilterNode(columns_to_drop=[])(df=out_9763_1)
    # Calibration (primary energy demand & emissions)
    out_9763_1 = ColumnFilterNode(columns_to_drop=[])(df=out_9763_1)
    # capex-opex[MEUR]
    out_9763_5 = ColumnFilterNode(pattern='^.*$')(df=out_9763_5)
    # capex-opex [MEUR]
    out_9763_5 = ColumnFilterNode(pattern='^.*$')(df=out_9763_5)
    # Node 5876
    out = pd.concat([out_3, out_9763_5.set_index(out_9763_5.index.astype(str) + '_dup')])
    # Set to 0
    out = MissingValueNode(DTS_DT_O=[['org.knime.core.data.def.IntCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.StringCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.DoubleCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.FixedDoubleValueMissingCellHandlerFactory']], FixedValue='0.0')(df=out)
    # capex-opex [MEUR]
    out = ColumnFilterNode(pattern='^.*$')(df=out)
    # Node 5876
    ...
    out = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector', 'way-of-production'], aggregation_method='Sum')(df=out_2)
    # Set to 0
    out = MissingValueNode(DTS_DT_O=[['org.knime.core.data.def.IntCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.StringCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.DoubleCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.FixedDoubleValueMissingCellHandlerFactory']], FixedValue='0.0')(df=out)
    # capex-opex[MEUR]
    out_3 = ColumnFilterNode(pattern='^.*$')(df=out)
    ...
    # capex-opex[MEUR]
    out_4 = ColumnFilterNode(pattern='^.*$')(df=out_3)
    ...
    # capex-opex[MEUR]
    out_5 = ColumnFilterNode(pattern='^.*$')(df=out_4)
    # Keep sector = efuels
    out_4 = out_5.loc[out_5['sector'].isin(['efuels'])].copy()
    # capex-opex[MEUR]
    out_5 = ColumnFilterNode(pattern='^.*$')(df=out_5)

    # For : Costs
    # Capex / Opex

    # capex-opex[MEUR]
    out_6 = ColumnFilterNode(pattern='^.*$')(df=out_5)
    # sector = electricity
    out_7 = out_6.loc[out_6['sector'].isin(['electricity'])].copy()
    # Group by  Country, Years, way-of-production (sum)
    out_7 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production'], aggregation_method='Sum')(df=out_7)
    # opex/capex -by-way-of-prod
    out_7 = ColumnRenameRegexNode(search_string='(.*)(\\[.*)', replace_string='$1-by-way-of-prod$2')(df=out_7)
    # Group by  Country, Years, sector (sum)
    out_6 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=out_6)
    out_6 = pd.concat([out_6, out_7.set_index(out_7.index.astype(str) + '_dup')])
    # Keep sector = heat
    out_5 = out_5.loc[out_5['sector'].isin(['heat'])].copy()
    # capex-opex[MEUR]
    out_2 = ColumnFilterNode(pattern='^.*$')(df=out_2)
    # Group by  Country, Years, cost-user (sum)
    out_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'cost-user'], aggregation_method='Sum')(df=out_2)
    out_2 = pd.concat([out_2, out_6.set_index(out_6.index.astype(str) + '_dup')])
    # energy-production[TWh]
    energy_production_TWh_3 = ExportVariableNode(selected_variable='energy-production[TWh]')(input_table=out_9763_4)
    ...
    # energy-production [TWh]
    energy_production_TWh = UseVariableNode(selected_variable='energy-production[TWh]')(input_table=energy_production_TWh_2)
    # Keep sector = electricity
    ...
    energy_production_TWh_4 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'primary-energy-carrier', 'sector'], aggregation_method='Sum')(df=energy_production_TWh_3)
    # Group by  energy-carrier
    energy_production_TWh_3 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=energy_production_TWh_4)
    ...
    energy_production_TWh_4 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=energy_production_TWh_4)
    # coal_in_elc_production[%] = energy-demand[TWh] (coal only) / energy-demand[TWh] (total)
    share_of_coal_in_production_percent = MCDNode(operation_selection='x / y', output_name='share-of-coal-in-production[%]')(input_table_1=energy_production_TWh_4, input_table_2=energy_production_TWh_3)
    # share-of-coal-in-production[%]
    share_of_coal_in_production_percent = ExportVariableNode(selected_variable='share-of-coal-in-production[%]')(input_table=share_of_coal_in_production_percent)
    ...
    # Group by Country, Years, sector (sum)
    energy_production_TWh_4 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=energy_production_TWh_3)
    # carbon-intensity[MtCO2/TWh] = emissions[MtCO2eq] / energy-production[TWh]
    carbon_intensity_MtCO2_per_TWh = MCDNode(operation_selection='x / y', output_name='carbon-intensity[MtCO2/TWh]')(input_table_1=emissions_MtCO2eq, input_table_2=energy_production_TWh_4)
    ...
    carbon_intensity_gCO2eq_per_kWh = ExportVariableNode(selected_variable='carbon-intensity[gCO2eq/kWh]')(input_table=carbon_intensity_gCO2eq_per_kWh)
    # KPI
    ...
    energy_production_TWh_3 = GroupByDimensions(groupby_dimensions=['energy-carrier', 'sector'], aggregation_method='Sum')(df=energy_production_TWh_3)
    energy_production_TWh_3 = MissingValueNode(dimension_rx='^.*\\[.*•\\]$', DTS_DT_O=[['org.knime.core.data.def.StringCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.FixedStringValueMissingCellHandlerFactory'], ['org.knime.core.data.def.DoubleCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory']], FixedValue='undefined')(df=energy_production_TWh_3)
    # 1
    ...
    carbon_intensity_gCO2eq_per_kWh = MCDNode(operation_selection='x * y', output_name='carbon-intensity[gCO2eq/kWh]')(input_table_1=carbon_intensity_gCO2eq_per_kWh, input_table_2=out_9779_1)
    # Group by country, years, energy-carrier (sum)
    carbon_intensity_gCO2eq_per_kWh = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=carbon_intensity_gCO2eq_per_kWh)
    # For climate
    out_9773_1 = pd.concat([carbon_intensity_gCO2eq_per_kWh, emissions_Mt.set_index(emissions_Mt.index.astype(str) + '_dup')])
    # Module = Climate
    out_9773_1 = ColumnFilterNode(pattern='^.*$')(df=out_9773_1)

    # For : Water
    # - Energy-production by way of production (only electricity sector)

    # energy-production [TWh]
    energy_production_TWh_3 = UseVariableNode(selected_variable='energy-production[TWh]')(input_table=energy_production_TWh)
    # Keep energy-carrier = electricity
    energy_production_TWh_4 = energy_production_TWh_3.loc[energy_production_TWh_3['energy-carrier'].isin(['electricity'])].copy()
    # Group by  Country, Years, way-of-production (sum)
    energy_production_TWh_4 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'way-of-production'], aggregation_method='Sum')(df=energy_production_TWh_4)
    # Module = Water
    energy_production_TWh_4 = ColumnFilterNode(pattern='^.*$')(df=energy_production_TWh_4)
    # Exclude energy-carrier = liquid-syn-.*
    ...
    # Group by  country, years, way-of-prod, energy-carrier, primary-energy-carrier
    energy_production_TWh_excluded = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'way-of-production', 'primary-energy-carrier'], aggregation_method='Sum')(df=energy_production_TWh_excluded)
    # net-energy-production-by- carrier-primary- carrier-way-of-prod[TWh]
    ...
    energy_production_TWh_6 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'way-of-production', 'primary-energy-carrier'], aggregation_method='Sum')(df=energy_production_TWh_6)
    ...
    # Group by  country, years, sector
    energy_production_TWh_5 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=energy_production_TWh_5)
    ...
    # fuel-price [MEUR/TWh]
    fuel_price_MEUR_per_TWh_2 = ExportVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=out_6469_2)
    # fuel-price [MEUR/TWh]
    fuel_price_MEUR_per_TWh_2 = UseVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=fuel_price_MEUR_per_TWh_2)
    # Node 5876
    ...
    electricity_COE_EUR_per_MWh = ExportVariableNode(selected_variable='electricity-COE[EUR/MWh]')(input_table=out_6469_3)

    # For : Costs
    # COE

    # electricity-COE [EUR/MWh]
    electricity_COE_EUR_per_MWh = UseVariableNode(selected_variable='electricity-COE[EUR/MWh]')(input_table=electricity_COE_EUR_per_MWh)
    # final-energy-costs [MEUR]
    final_energy_costs_MEUR = ExportVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=out_6469_1)
    # final-energy-costs [MEUR]
    final_energy_costs_MEUR_2 = UseVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=final_energy_costs_MEUR)
    # Node 5876
    ...
    # final-energy-costs [MEUR]
    final_energy_costs_MEUR_2 = UseVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=final_energy_costs_MEUR_2)
    # Group by  country, years, sector
    final_energy_costs_MEUR = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=final_energy_costs_MEUR)
    ...
    # primary-costs [MEUR]
    primary_costs_MEUR = UseVariableNode(selected_variable='primary-costs[MEUR]')(input_table=out_6505_1)
    # Keep only sector hydrogen
    primary_costs_MEUR_2 = primary_costs_MEUR.loc[primary_costs_MEUR['sector'].isin(['hydrogen'])].copy()
    # Group by  country, years, sector
    primary_costs_MEUR_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=primary_costs_MEUR_2)
    # Keep only energy-carrier hydrogen
    ...
    # fuel-price [MEUR/TWh]
    fuel_price_MEUR_per_TWh_2 = ExportVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=out_6480_2)
    # fuel-price [MEUR/TWh]
    fuel_price_MEUR_per_TWh_2 = UseVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=fuel_price_MEUR_per_TWh_2)
    # Node 5876
    fuel_price_MEUR_per_TWh = pd.concat([fuel_price_MEUR_per_TWh_2, fuel_price_MEUR_per_TWh.set_index(fuel_price_MEUR_per_TWh.index.astype(str) + '_dup')])
    ...
    fuel_price_MEUR_per_TWh = UseVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=fuel_price_MEUR_per_TWh)
    # final-energy-costs [MEUR]
    final_energy_costs_MEUR = ExportVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=out_6480_1)
    # final-energy-costs [MEUR]
    final_energy_costs_MEUR_3 = UseVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=final_energy_costs_MEUR)
    # Node 5876
    ...
    # primary-costs [MEUR]
    primary_costs_MEUR = UseVariableNode(selected_variable='primary-costs[MEUR]')(input_table=out_6508_1)
    # Keep only energy-carrier syn fuels
    ...
    # fuel-price [MEUR/TWh]
    fuel_price_MEUR_per_TWh_2 = ExportVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=out_6501_2)
    # fuel-price [MEUR/TWh]
    fuel_price_MEUR_per_TWh_2 = UseVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=fuel_price_MEUR_per_TWh_2)
    # Node 5876
    fuel_price_MEUR_per_TWh = pd.concat([fuel_price_MEUR_per_TWh_2, fuel_price_MEUR_per_TWh.set_index(fuel_price_MEUR_per_TWh.index.astype(str) + '_dup')])
    ...
    fuel_price_MEUR_per_TWh = UseVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=fuel_price_MEUR_per_TWh)
    # final-energy-costs [MEUR]
    final_energy_costs_MEUR = ExportVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=out_6501_1)
    # final-energy-costs [MEUR]
    final_energy_costs_MEUR_3 = UseVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=final_energy_costs_MEUR)
    # Node 5876
    final_energy_costs_MEUR_2 = pd.concat([final_energy_costs_MEUR_3, final_energy_costs_MEUR_2.set_index(final_energy_costs_MEUR_2.index.astype(str) + '_dup')])
    ...
    # primary-costs [MEUR]
    primary_costs_MEUR = UseVariableNode(selected_variable='primary-costs[MEUR]')(input_table=out_6510_1)
    # energy-production [TWh]
    energy_production_TWh = UseVariableNode(selected_variable='energy-production[TWh]')(input_table=energy_production_TWh_3)
    # Keep only energy-carrier heat
    ...
    # fuel-price [MEUR/TWh]
    fuel_price_MEUR_per_TWh_2 = ExportVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=out_6514_2)
    # fuel-price [MEUR/TWh]
    fuel_price_MEUR_per_TWh_2 = UseVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=fuel_price_MEUR_per_TWh_2)
    # Node 5876
    fuel_price_MEUR_per_TWh = pd.concat([fuel_price_MEUR_per_TWh_2, fuel_price_MEUR_per_TWh.set_index(fuel_price_MEUR_per_TWh.index.astype(str) + '_dup')])
    # fuel-price [MEUR/TWh]
    fuel_price_MEUR_per_TWh = ExportVariableNode(selected_variable='fuel-price[MEUR/TWh]')(input_table=fuel_price_MEUR_per_TWh)
    ...
    # final-energy-costs [MEUR]
    final_energy_costs_MEUR = ExportVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=out_6514_1)
    # final-energy-costs [MEUR]
    final_energy_costs_MEUR = UseVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=final_energy_costs_MEUR)
    # Node 5876
    ...
    # final-energy-costs [MEUR]
    final_energy_costs_MEUR = ExportVariableNode(selected_variable='final-energy-costs[MEUR]')(input_table=final_energy_costs_MEUR)
    # If missing txt set to "" (efuels => way-of-prod and energy-carrier-cat if non efuels)
    final_energy_costs_MEUR = MissingValueNode(dimension_rx='^.*\\[.*•\\]$', DTS_DT_O=[['org.knime.core.data.def.IntCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory'], ['org.knime.core.data.def.StringCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.FixedStringValueMissingCellHandlerFactory'], ['org.knime.core.data.def.DoubleCell', 'org.knime.base.node.preproc.pmml.missingval.handlers.DoNothingMissingCellHandlerFactory']], FixedValue='')(df=final_energy_costs_MEUR)
    ...
    out_7313_1 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier', 'sector'], aggregation_method='Sum')(df=out_7313_1)
    ...
    out_7313_1_2 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'energy-carrier'], aggregation_method='Sum')(df=out_7313_1)
    ...
    out_7313_1 = GroupByDimensions(groupby_dimensions=['Country', 'Years', 'sector'], aggregation_method='Sum')(df=out_7313_1)
    ...
    out_9382_1 = AddTrigram()(module_name=module_name, df=out)
    # Module = Pathway Explorer + Costs  + KPIs
    out_9382_1 = ColumnFilterNode(pattern='^.*$')(df=out_9382_1)
    # Calibration (enery-demand)
    cal_rate_energy_demand_TWh_2 = ExportVariableNode(selected_variable='cal_rate_energy-demand[TWh]')(input_table=out_7248_2)
