...
def metanode_7083(port_01):
    ...
    energy_demand = ImportDataNode(trigram='elc', variable_name='energy-demand', variable_type='Calibration')()
    # Apply Calibration on energy-demand [TWh]
    _, out_0_2, out_0_3 = CalibrationNode(data_to_be_cal='energy-demand[TWh]', data_cal='energy-demand[TWh]')(input_table=energy_demand_TWh_2, cal_table=energy_demand)
    ...
    energy_demand_TWh = MCDNode(operation_selection='x * y', output_name='energy-demand[TWh]', fill_value_bool='Left [x] Outer Join', fill_value=1.0)(input_table_1=energy_demand_TWh, input_table_2=out_0_2)
