...
def metanode_6514(port_01, port_02, port_03, port_04):
    ...
    exogenous_energy_costs_MEUR_per_TWh_2 = group_by_dimensions(df=exogenous_energy_costs_MEUR_per_TWh, groupby_dimensions=['Years', 'Country'], aggregation_method='Mean')

    # Calibration

    # Apply Calibration on fuel-price[MEUR/TWh]
    fuel_price_endogenous_MEUR_per_TWh, _, _ = calibration(input_table=fuel_price_endogenous_MEUR_per_TWh, cal_table=exogenous_energy_costs_MEUR_per_TWh_2, data_to_be_cal='fuel-price-endogenous[MEUR/TWh]', data_cal='exogenous-energy-costs[EUR/MWh]')
