...
class FuelMixNode(PythonNode, SubNode):
    def __init__(
        self,
        ...
        self.col_category_from = col_category_from
        self.col_category_to = col_category_to
    ...
    def from_knime(cls, ctx: Context, id, xml_root, xmlns, flow_vars_params):
        ...
        #       "The fuel switch node is not connected to the EUCalc - Unit conversion metanode template.")
        #else:
        ...
        #       cls.knime_error(id,
        #           "The template of the EUCalc - Unit conversion 2 metanode was updated. Please check the version that you're using")
        kwargs = {}
        ...
        for child in model:
            ...
            match child_key:
                ...
                case "column-selection-678":
                    kwargs["col_category_from"] = value
                case "column-selection-679":
                    kwargs["col_category_to"] = value
    ...
    def apply(self, input_energy, switch_values, values_to_from) -> pd.DataFrame:
        # Variables
        col_energy = self.col_energy
        col_category_from = self.col_category_from
        col_category_to = self.col_category_to
