...
class Python12Node(Node):
    ...
    def run(self):
        ...
        for var in self.flow_vars:
            if isinstance(self.flow_vars[var], tuple):
                flow_variables[var] = self.flow_vars[var][1]


        ns = {'output_table_1': None, 'output_table_2': None, 'input_table': input_table, 'flow_variables': flow_variables}
